...
from app.schemas.base import Paginated, SciLoopModel
from app.schemas.enums import IdType, ParseStatus, SpanVerdict
...
class EvidenceVerification(SciLoopModel):
    """``app.services.fulltext.locator.verify_span`` 的返回口径。
