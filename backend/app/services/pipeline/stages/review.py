...
from app.services.review import reviewer, scorer
from app.services.writing import drafter
...
async def run(ctx: StageContext) -> StageResult:
    ...
    from app.services.pipeline.stop_conditions import evaluate_stop_conditions, resolve_thresholds
