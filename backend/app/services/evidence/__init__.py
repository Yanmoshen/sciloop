...
绑定（供 WP08 / WP14）::
    ...
    from app.services.evidence import bind_evidence, bind_evidence_detailed
...
拆分与判定::
    ...
    from app.services.evidence import split_claims, split_and_persist, verify_claims
...
度量::
    ...
    from app.services.evidence import claim_coverage        # supported ÷ 事实性总数
...
from app.services.evidence.claim_splitter import (
    MIN_FACTUAL_CHARS,
    classify_factual,
    clean_inline,
    persist_claims,
...
from app.services.evidence.integrity_checker import (
    CITATION_RE,
    load_draft,
