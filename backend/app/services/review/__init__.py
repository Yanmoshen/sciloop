...
对外契约（供 ``plan_review`` 环节与 ``api/v1/calibration.py`` 使用）::
    ...
    from app.services.review import blind, calibration
...
- :mod:`app.services.review.blind` —— 隔离校验 / 匿名化 / 固定种子乱序
- :mod:`app.services.review.calibration` —— 人工标签、Cohen kappa / MAE、样本量披露
