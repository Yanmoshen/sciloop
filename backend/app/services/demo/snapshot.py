...
::
    ...
    python -m app.services.demo.snapshot --dry-run          # 体检
    python -m app.services.demo.snapshot --replace          # 固化三视图快照
"""
...
from app.db.models.paper import Paper, PaperFeedSnapshot
...
def _ordered_ids(session: Any, view: str, limit: int) -> list[int]:
    ...
    from app.api.v1.feed import order_by_for_view
