...
from app.db.models import Feasibility, Idea
from app.services.aggregation.cards import load_cards
from app.services.cost import accumulate
from app.services.evidence import bind_evidence_detailed
from app.services.feasibility import mve_planner, risk_analyzer, scorer
