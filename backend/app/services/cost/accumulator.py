...
:mod:`app.services.cost.classification`：
...
- HTTP：``GET /api/v1/costs/summary?project_id=``（见 :mod:`app.api.v1.costs`）
...
from app.services.cost.queries import fetch_cost_buckets
