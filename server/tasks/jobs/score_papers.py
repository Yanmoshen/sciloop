...
# 说明：并行开发期受 owned_paths 限制无法新建共享模块；WP01 的 db.session 到位后二者都会复用它。
from api.v1.feed import get_session_factory
...
def main(argv: Iterable[str] | None = None) -> int:
    """命令行入口：``python -m tasks.jobs.score_papers [limit] [--force]``。"""
