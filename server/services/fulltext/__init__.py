...
对外契约（供 WP06 / WP07 / WP13 使用）::
    ...
    from services.fulltext import DocumentStore, verify_span, list_spans
...
from services.fulltext.document_store import (
    DocumentStore,
    Fetcher,
    FetchResult,
    HttpxFetcher,
...
from services.fulltext.locator import (
    build_span,
    build_spans,
    relocate_quote,
    verify_span,
...
from services.fulltext.pdf_parser import NoTextLayerError, parse_pdf
...
from services.fulltext.repository import (
    DocumentRepository,
    InMemoryDocumentRepository,
    SqlDocumentRepository,
)
from services.fulltext.section_map import (
    SECTION_NAMES,
    looks_like_heading,
