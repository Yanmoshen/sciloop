...
stage: writing
source: K-Dense-AI/scientific-agent-skills/skills/scientific-slides
requires_env:
- name: OPENROUTER_API_KEY
  required: false
steps:
- id: generate_schematic
  title: generate schematic
  script: scripts/generate_schematic.py
  args:
  - '{{in}}'
  - -o
  - --doc-type
  ...
  outputs: []
  required: false
- id: generate_schematic_ai
  title: generate schematic ai
  script: scripts/generate_schematic_ai.py
  args:
  - '{{in}}'
  - -o
  - --iterations
  ...
  outputs: []
  required: false
- id: generate_slide_image
  title: generate slide image
  script: scripts/generate_slide_image.py
  args:
  - '{{in}}'
  - -o
  - --attach
  ...
  outputs: []
  required: false
- id: generate_slide_image_ai
  title: generate slide image ai
  script: scripts/generate_slide_image_ai.py
  args:
  - '{{in}}'
  - -o
  - --attach
...
- id: slides_to_pdf
  title: slides to pdf
  script: scripts/slides_to_pdf.py
  args:
  - '{{in}}'
  - -o
  - --dpi
...
- id: validate_presentation
  ...
  script: scripts/validate_presentation.py
  args:
  - '{{in}}'
  - --duration
  - --quiet
