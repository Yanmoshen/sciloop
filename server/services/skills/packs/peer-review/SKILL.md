...
stage: ideation
source: K-Dense-AI/scientific-agent-skills/skills/peer-review
steps:
- id: audit_citations
  title: audit citations
  script: scripts/audit_citations.py
  args:
  - '{{in}}'
  - -o
  - --force
  outputs: []
  required: false
- id: audit_statistics_reproducibility
  title: audit statistics reproducibility
  script: scripts/audit_statistics_reproducibility.py
  args:
  - '{{in}}'
  - -o
  - --force
  outputs: []
  required: false
- id: generate_review_scaffold
  title: generate review scaffold
  script: scripts/generate_review_scaffold.py
  args:
  - '{{in}}'
  - -o
  - --force
...
- id: lint_review
  ...
  outputs: []
  required: false
- id: select_reporting_guidelines
  title: select reporting guidelines
  script: scripts/select_reporting_guidelines.py
  args:
  - '{{in}}'
  - --coverage
  - -o
  ...
  outputs: []
  required: false
- id: validate_claim_evidence
  title: validate claim evidence
  script: scripts/validate_claim_evidence.py
  args:
  - '{{in}}'
  - -o
  - --force
  outputs: []
  required: false
- id: validate_review_intake
  title: validate review intake
  script: scripts/validate_review_intake.py
  args:
  - '{{in}}'
  - -o
  - --force
