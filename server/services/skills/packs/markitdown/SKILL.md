...
stage: writing
source: K-Dense-AI/scientific-agent-skills/skills/markitdown
steps:
- id: batch_convert
  title: batch convert
  script: scripts/batch_convert.py
  args:
  - '{{in}}'
  - --extensions
  - --recursive
  ...
  outputs: []
  required: false
- id: convert_literature
  title: convert literature
  script: scripts/convert_literature.py
  args:
  - '{{in}}'
  - --recursive
  - --organize-by-year
  ...
  outputs: []
  required: false
- id: inspect_installation
  title: inspect installation
  script: scripts/inspect_installation.py
  args:
  - '{{in}}'
  - --json
