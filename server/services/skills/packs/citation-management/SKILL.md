...
stage: literature
source: K-Dense-AI/scientific-agent-skills/skills/citation-management
requires_env:
- name: NCBI_EMAIL
  required: false
- name: NCBI_API_KEY
...
- id: doi_to_bibtex
  title: doi to bibtex
  script: scripts/doi_to_bibtex.py
  args:
  - '{{in}}'
  - -i
  - -o
...
- id: format_bibtex
  title: format bibtex
  script: scripts/format_bibtex.py
  args:
  - '{{in}}'
  - -o
  - --in-place
  ...
  outputs: []
  required: false
- id: search_google_scholar
  title: search google scholar
  script: scripts/search_google_scholar.py
  args:
  - '{{in}}'
  - --limit
  - --year-start
...
- id: search_openalex
  ...
  script: scripts/search_openalex.py
  args:
  - '{{in}}'
  - --limit
  - --year-start
