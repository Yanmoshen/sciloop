...
stage: figure
source: K-Dense-AI/scientific-agent-skills/skills/infographics
license: MIT license
requires_env:
- name: OPENROUTER_API_KEY
  required: false
...
- id: generate_infographic
  ...
  outputs: []
  required: false
- id: generate_infographic_ai
  title: generate infographic ai
  script: scripts/generate_infographic_ai.py
  args:
  - '{{in}}'
  - -o
  - --type
