...
stage: ideation
source: K-Dense-AI/scientific-agent-skills/skills/hypothesis-generation
steps:
- id: audit_evidence_ledger
  title: audit evidence ledger
  script: scripts/audit_evidence_ledger.py
  args:
  - '{{in}}'
  - --record
  - -o
  ...
  outputs: []
  required: false
- id: check_falsification_controls
  title: check falsification controls
  script: scripts/check_falsification_controls.py
  args:
  - '{{in}}'
  - --record
  - -o
  ...
  outputs: []
  required: false
- id: check_operationalization
  title: check operationalization
  script: scripts/check_operationalization.py
  args:
  - '{{in}}'
  - -o
  - --force
  outputs: []
  required: false
- id: generate_preregistration_scaffold
  title: generate preregistration scaffold
  script: scripts/generate_preregistration_scaffold.py
  args:
  - '{{in}}'
  - -o
  - --force
  outputs: []
  required: false
- id: lint_causal_claims
  title: lint causal claims
  script: scripts/lint_causal_claims.py
  args:
  - '{{in}}'
  - -o
  - --force
  outputs: []
  required: false
- id: validate_hypothesis_schema
  title: validate hypothesis schema
  script: scripts/validate_hypothesis_schema.py
  args:
  - '{{in}}'
  - -o
  - --force
  outputs: []
  required: false
- id: validate_prediction_matrix
  title: validate prediction matrix
  script: scripts/validate_prediction_matrix.py
  args:
  - '{{in}}'
  - --record
  - -o
