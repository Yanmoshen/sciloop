...
抛 :class:`~services.review.blind.IsolationStageError`（同时是 ``StageError``
...
from services.review import blind
from services.review.calibration import DIMENSIONS, SCORE_MAX, TOTAL_MAX
...
def _model_scores_for_db(
    ...
    from services.review.calibration import build_model_scores
