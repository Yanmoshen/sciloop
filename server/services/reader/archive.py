...
归档内容（ZIP，条目名全部经 :func:`services.reader.storage.safe_zip_name` 校验）::
...
from db.models.reader import ReaderAnnotation, ReaderDocument, ReaderState, ReaderVersion
from services.reader import annotations as annotations_service
from services.reader import storage, versions
