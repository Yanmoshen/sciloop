...
from llm.errors import IsolationViolation, LLMError, SecretBackendUnavailable
from llm.pricing import parse_price_info
from llm.providers import models_url
from llm.registry import STAGES, get_registry
from llm.router import get_router
from llm.secret import (
    decrypt_api_key,
    encrypt_api_key,
    is_env_ref,
    key_fingerprint,
...
from services.paper_source.cache import get_source_http
...
def _owner_dependency() -> Any:
    """优先复用 WP01 的 ``core.security`` 依赖；未就绪时用等价本地实现。"""
    try:
        from core import security  # type: ignore
