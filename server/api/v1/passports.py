...
from db.models.pipeline import Experiment, ExperimentRun, PipelineRun, StageOutput
...
def _register_experiment_stage() -> str:
    ...
    try:
        from services.pipeline.stages.experiment import register
...
def _fixture_source(records: Sequence[Mapping[str, Any]]) -> dict[str, Any]:
    ...
    from services.experiment.templates.common import fixture_key
...
async def _reproduce(
    ...
    *,
    ...
    from services.experiment import diff as diff_mod
