...
from services.paper_source.cache import cache_stats
from tasks.jobs import fetch_papers
...
def papers_overview(session: DbSession) -> dict[str, Any]:
    ...
    from db.models import Aggregation, PaperCard, PaperDocument, PaperSourceRecord
...
def paper_trends(
    ...
    **「已解析」口径与 `/papers/overview` 完全一致**：既有解析成功的全文文档、又有解析卡片；
    ...
    from db.models import PaperCard, PaperDocument
